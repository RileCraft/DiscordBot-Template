module.exports = {
    ...
    console.log(chalk.bold.yellow("[Handler]") + chalk.bold.blue(` Loaded ${info.loadedButtons[info.loadedButtons.length - 1] ?? 0} buttons.`))
    console.log(chalk.bold.white("[Handler]") + chalk.bold.green(` Loaded ${info.loadedSelectMenus[info.loadedSelectMenus.length - 1] ?? 0} selectMenus.`))
	},
};