...
else interaction.reply({ embeds: [embedLoader.clientPermissions(author, data.missingClientPermissions)] })
 }
...
else interaction.reply({ embeds: [embedLoader.anyUserPermissions(author, data.missingAnyUserPermissions)] })
  }
